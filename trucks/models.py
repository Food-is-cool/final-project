...
class TruckProfile(models.Model):
    ...
    item_1_price = models.FloatField(max_length=255, null=True, blank=True)
    item_2_price = models.FloatField(max_length=255, null=True, blank=True)
    item_3_price = models.FloatField(max_length=255, null=True, blank=True)
    item_4_price = models.FloatField(max_length=255, null=True, blank=True)
    item_5_price = models.FloatField(max_length=255, null=True, blank=True)
    item_6_price = models.FloatField(max_length=255, null=True, blank=True)
    item_7_price = models.FloatField(max_length=255, null=True, blank=True)
    item_8_price = models.FloatField(max_length=255, null=True, blank=True)
    item_9_price = models.FloatField(max_length=255, null=True, blank=True)
    item_10_price = models.FloatField(max_length=255, null=True, blank=True)
